const passwordElement = document.querySelector('.validate-password')
if (!passwordElement) console.warn('Password element not found.')

const [green, red] = ['rgb(0, 208, 38)', 'rgb(220, 53, 69)']
