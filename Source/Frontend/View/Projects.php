...
$statisticsData = [
    ...
    'completed'     => htmlspecialchars(formatNumber($projects?->countByStatus(WorkStatus::COMPLETED) ?? 0)),
    'cancelled'     => htmlspecialchars(formatNumber($projects?->countByStatus(WorkStatus::CANCELLED) ?? 0)),
    'messages'      => [
        'insights'          => [],
        'recommendations'   => []
    ]
...
<body>
    ...
    <script type="module" src="<?= EVENT_PATH . 'Projects' . DS . 'InfiniteScroll.js' ?>" defer></script>
