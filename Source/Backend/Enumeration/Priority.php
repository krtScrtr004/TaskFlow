...
enum Priority: string {
    ...
    /**
     * Returns a human-readable display name for the Priority enum.
     *
     ...
     *
     * @return string Human-friendly display name for this Priority value
    ...
    /**
     * Renders an HTML priority badge for a given Priority.
     *
     * This method:
     * - Obtains the human-readable priority label via $priority->getDisplayName()
     * - Maps the Priority to a background CSS class:
     *     - self::LOW    => 'green-bg'
     ...
     *
     * @param Priority $priority The priority enum instance to render (expected values: LOW, MEDIUM, HIGH)
     *
