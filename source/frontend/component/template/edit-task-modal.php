    ...
    <div class="modal-form modal flex-col black-bg">
        ...
        <section class="flex-row flex-space-between">
            <div class="text-w-icon">
                <img src="<?= ICON_PATH . 'task_w.svg' ?>" alt="Edit Task" title="Edit Task"
                    height="25">
        ...
        <form id="edit_task_form" class="flex-col" method="POST" action="">
            ...
            <div class="input-label-container">
                ...
                <input type="text" name="task_name" id="task_name" min="1" max="255" placeholder="Task Name" value="<?= $taskData['name'] ?>"
                    required>
            </div>
            ...
            <div class="input-label-container">
                ...
                <textarea name="task_description" id="task_description" rows="4"
                    placeholder="Task Description (optional)"><?= $taskData['description'] ?></textarea>
            </div>
