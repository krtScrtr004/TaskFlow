<form id="login_form" class="index-form flex-col" action="" method="POST">
    <input type="text" id="login_email" name="login_email" min="8" max="255" placeholder="Please enter your email here"
    ...
    <div class="password-toggle-wrapper">
        ...
        <input type="password" name="login_password" id="login_password" placeholder="Please enter your password here" min="8"
            max="255" required />
    </div>
