...
// import { cancelAddWorkerModal } from './modal.js'
...
// function searchWorkerEvent(projectId, endpoint) {
//     const addWorkerModalTemplate = document.querySelector('#add_worker_modal_template')
...
//     searchBarForm.addEventListener('submit', e => debounceAsync(searchForWorker(e, projectId, endpoint), 300))
//     button.addEventListener('click', e => debounceAsync(searchForWorker(e, projectId, endpoint), 300))
// }

// async function searchForWorker(e, projectId, endpoint) {
//     e.preventDefault()
...
// function infiniteScrollWorkers(projectId, endpoint, searchKey = '') {
...
// function createInfiniteScrollObserver(workerList, sentinel, projectId, endpoint, searchKey) {
...
//     return await fetchFromDatabase(projectId, endpoint, key, isFetchingWorkers, offset)
//         .catch(error => {
//             throw error
//         })
// }
...
//         const param = (key) ? key : ''
//         // const endpoint = (searchEndpoint === 'workers')
...
// r) {
        han// dleException(error, `Erro// r addin// g workers: ${error.message}`)
//     } finally {
//         Loader.delete()
//     }
// }